...
require (
  git.zyria.de/pyrox/hugo-default-coder v0.0.0-20250513185938-f89458e6f5cb // indirect
  git.zyria.de/pyrox/hugo-legal v0.0.0-20250513081621-c909a1ce8af8 // indirect
